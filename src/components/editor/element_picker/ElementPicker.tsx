...
import { ElementDataContainer } from "./ElementDataContainer.tsx";

export const ElementPicker: React.FC = () => {
  const [showSelectionMenu, setShowSelectionMenu] = useState<boolean>(false);

  return (
    <div className="block absolute enablePointerEvents" style={{ bottom: "0", right: "46vw" }}>
      <div
      ...
      {showSelectionMenu && (
        ...
        >
          ...
          <TextInput
            className="rounded-sm highlight g:text-lg md:text-base sm:text-sm"
            placeholder="Search..."
            style={{ width: "100%" }}
          />
