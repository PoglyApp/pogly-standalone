 ...
 */
export const UpdateElementTransparency = {
  /**
  ...
  */
  ...
  serialize(writer: __BinaryWriter, value: UpdateElementTransparency): void {
    __AlgebraicTypeValue.serializeValue(writer, UpdateElementTransparency.getTypeScriptAlgebraicType(), value);
  },

  deserialize(reader: __BinaryReader): UpdateElementTransparency {
    return __AlgebraicTypeValue.deserializeValue(reader, UpdateElementTransparency.getTypeScriptAlgebraicType());
  },

}

export default UpdateElementTransparency;
