...
export const GuestNames = {
  ...
  */
  getTypeScriptAlgebraicType(): __AlgebraicTypeType {
    if (_cached_GuestNames_type_value) return _cached_GuestNames_type_value;
    _cached_GuestNames_type_value = __AlgebraicTypeValue.Product({ elements: [] });
  ...
  serialize(writer: __BinaryWriter, value: GuestNames): void {
    __AlgebraicTypeValue.serializeValue(writer, GuestNames.getTypeScriptAlgebraicType(), value);
  },

  deserialize(reader: __BinaryReader): GuestNames {
    return __AlgebraicTypeValue.deserializeValue(reader, GuestNames.getTypeScriptAlgebraicType());
  },
