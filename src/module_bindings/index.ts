...
const REMOTE_MODULE = {
  tables: {
    AuditLog: {
      ...
      primaryKeyInfo: {
        colName: "id",
        colType: AuditLog.getTypeScriptAlgebraicType().product.elements[0].algebraicType,
      },
    },
    AuthenticationKey: {
    ...
    ElementData: {
      ...
      primaryKeyInfo: {
        colName: "id",
        colType: ElementData.getTypeScriptAlgebraicType().product.elements[0].algebraicType,
      },
    },
    Elements: {
      tableName: "Elements",
      ...
      primaryKeyInfo: {
        colName: "id",
        colType: Elements.getTypeScriptAlgebraicType().product.elements[0].algebraicType,
      },
    },
    Folders: {
      tableName: "Folders",
      ...
      primaryKeyInfo: {
        colName: "id",
        colType: Folders.getTypeScriptAlgebraicType().product.elements[0].algebraicType,
      },
    },
    Guests: {
      tableName: "Guests",
      ...
      primaryKeyInfo: {
        colName: "address",
        colType: Guests.getTypeScriptAlgebraicType().product.elements[0].algebraicType,
      },
    },
    Heartbeat: {
      tableName: "Heartbeat",
      ...
      primaryKeyInfo: {
        colName: "id",
        colType: Heartbeat.getTypeScriptAlgebraicType().product.elements[0].algebraicType,
      },
    },
    KeepAliveWorker: {
      ...
      primaryKeyInfo: {
        colName: "id",
        colType: KeepAliveWorker.getTypeScriptAlgebraicType().product.elements[0].algebraicType,
      },
    },
    Layouts: {
      tableName: "Layouts",
      ...
      primaryKeyInfo: {
        colName: "id",
        colType: Layouts.getTypeScriptAlgebraicType().product.elements[0].algebraicType,
      },
    },
    OverlayCommand: {
    ...
    Permissions: {
      ...
      primaryKeyInfo: {
        colName: "identity",
        colType: Permissions.getTypeScriptAlgebraicType().product.elements[0].algebraicType,
      },
    },
    ZIndex: {
      tableName: "ZIndex",
      ...
      primaryKeyInfo: {
        colName: "version",
        colType: ZIndex.getTypeScriptAlgebraicType().product.elements[0].algebraicType,
      },
    },
  },
  reducers: {
