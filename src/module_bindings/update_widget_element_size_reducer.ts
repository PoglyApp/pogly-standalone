 ...
 */
export const UpdateWidgetElementSize = {
  /**
  ...
  */
  ...
  serialize(writer: __BinaryWriter, value: UpdateWidgetElementSize): void {
    __AlgebraicTypeValue.serializeValue(writer, UpdateWidgetElementSize.getTypeScriptAlgebraicType(), value);
  },

  deserialize(reader: __BinaryReader): UpdateWidgetElementSize {
    return __AlgebraicTypeValue.deserializeValue(reader, UpdateWidgetElementSize.getTypeScriptAlgebraicType());
  },

}

export default UpdateWidgetElementSize;
