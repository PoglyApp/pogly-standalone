 ...
 */
export const AddElementDataArray = {
  /**
  ...
  */
  ...
  serialize(writer: __BinaryWriter, value: AddElementDataArray): void {
    __AlgebraicTypeValue.serializeValue(writer, AddElementDataArray.getTypeScriptAlgebraicType(), value);
  },

  deserialize(reader: __BinaryReader): AddElementDataArray {
    return __AlgebraicTypeValue.deserializeValue(reader, AddElementDataArray.getTypeScriptAlgebraicType());
  },

}

export default AddElementDataArray;
