...
export const AddElement = {
  ...
  */
  ...
  serialize(writer: __BinaryWriter, value: AddElement): void {
    __AlgebraicTypeValue.serializeValue(writer, AddElement.getTypeScriptAlgebraicType(), value);
  },

  deserialize(reader: __BinaryReader): AddElement {
    return __AlgebraicTypeValue.deserializeValue(reader, AddElement.getTypeScriptAlgebraicType());
  },
