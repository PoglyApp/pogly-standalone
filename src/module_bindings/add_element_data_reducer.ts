 ...
 */
export namespace AddElementData {
  /**
  ...
  */
  ...
  export function serialize(writer: BinaryWriter, value: AddElementData): void {
    AddElementData.getTypeScriptAlgebraicType().serialize(writer, value);
  }

  export function deserialize(reader: BinaryReader): AddElementData {
    return AddElementData.getTypeScriptAlgebraicType().deserialize(reader);
  }
