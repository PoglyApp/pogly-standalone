...
export const AuthenticationKey = {
  ...
  */
  ...
  serialize(writer: __BinaryWriter, value: AuthenticationKey): void {
    __AlgebraicTypeValue.serializeValue(writer, AuthenticationKey.getTypeScriptAlgebraicType(), value);
  },

  deserialize(reader: __BinaryReader): AuthenticationKey {
    return __AlgebraicTypeValue.deserializeValue(reader, AuthenticationKey.getTypeScriptAlgebraicType());
  },
