...
declare type __keep_KeepAliveWorker = KeepAliveWorker;
...
export const KeepAlive = {
  ...
  */
  ...
  serialize(writer: __BinaryWriter, value: KeepAlive): void {
    __AlgebraicTypeValue.serializeValue(writer, KeepAlive.getTypeScriptAlgebraicType(), value);
  },

  deserialize(reader: __BinaryReader): KeepAlive {
    return __AlgebraicTypeValue.deserializeValue(reader, KeepAlive.getTypeScriptAlgebraicType());
  },
