...
export class ImportElementReducer extends Reducer
{
	public static reducerName: string = "ImportElement";
	public static call(_element: ElementStruct, _transparency: number, _transform: string, _clip: string, _layoutId: number, _placedBy: string, _lastEditedBy: string, _zindex: number, _folderId: number | null) {
		this.getReducer().call(_element, _transparency, _transform, _clip, _layoutId, _placedBy, _lastEditedBy, _zindex, _folderId);
	}

	public call(_element: ElementStruct, _transparency: number, _transform: string, _clip: string, _layoutId: number, _placedBy: string, _lastEditedBy: string, _zindex: number, _folderId: number | null) {
		...
		let _placedByType = AlgebraicType.createPrimitiveType(BuiltinType.Type.String);
		serializer.write(_placedByType, _placedBy);
		let _lastEditedByType = AlgebraicType.createPrimitiveType(BuiltinType.Type.String);
		serializer.write(_lastEditedByType, _lastEditedBy);
		...
		this.client.call("ImportElement", serializer);
	}
	...
	public static deserializeArgs(adapter: ReducerArgsAdapter): any[] {
		...
		let placedByType = AlgebraicType.createPrimitiveType(BuiltinType.Type.String);
		let placedByValue = AlgebraicValue.deserialize(placedByType, adapter.next())
		let placedBy = placedByValue.asString();
		let lastEditedByType = AlgebraicType.createPrimitiveType(BuiltinType.Type.String);
		let lastEditedByValue = AlgebraicValue.deserialize(lastEditedByType, adapter.next())
		let lastEditedBy = lastEditedByValue.asString();
		...
		return [element, transparency, transform, clip, layoutId, placedBy, lastEditedBy, zindex, folderId];
	}

	public static on(callback: (reducerEvent: ReducerEvent, _element: ElementStruct, _transparency: number, _transform: string, _clip: string, _layoutId: number, _placedBy: string, _lastEditedBy: string, _zindex: number, _folderId: number | null) => void) {
		this.getReducer().on(callback);
	}
	public on(callback: (reducerEvent: ReducerEvent, _element: ElementStruct, _transparency: number, _transform: string, _clip: string, _layoutId: number, _placedBy: string, _lastEditedBy: string, _zindex: number, _folderId: number | null) => void)
	{
		this.client.on("reducer:ImportElement", callback);
	}
}


export default ImportElementReducer
