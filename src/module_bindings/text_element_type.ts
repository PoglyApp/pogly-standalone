...
export const TextElement = {
  ...
  */
  ...
  serialize(writer: __BinaryWriter, value: TextElement): void {
    __AlgebraicTypeValue.serializeValue(writer, TextElement.getTypeScriptAlgebraicType(), value);
  },

  deserialize(reader: __BinaryReader): TextElement {
    return __AlgebraicTypeValue.deserializeValue(reader, TextElement.getTypeScriptAlgebraicType());
  },
