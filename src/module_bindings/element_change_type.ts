 ...
 */
export namespace ElementChange {
  /**
  ...
  */
  ...
  export function serialize(writer: BinaryWriter, value: ElementChange): void {
    ElementChange.getTypeScriptAlgebraicType().serialize(writer, value);
  }

  export function deserialize(reader: BinaryReader): ElementChange {
    return ElementChange.getTypeScriptAlgebraicType().deserialize(reader);
  }
