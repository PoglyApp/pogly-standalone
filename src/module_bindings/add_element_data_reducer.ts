...
export const AddElementData = {
  ...
  */
  ...
  serialize(writer: __BinaryWriter, value: AddElementData): void {
    __AlgebraicTypeValue.serializeValue(writer, AddElementData.getTypeScriptAlgebraicType(), value);
  },

  deserialize(reader: __BinaryReader): AddElementData {
    return __AlgebraicTypeValue.deserializeValue(reader, AddElementData.getTypeScriptAlgebraicType());
  },

}

export default AddElementData;
