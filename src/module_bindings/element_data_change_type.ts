 ...
 */
export const ElementDataChange = {
  /**
  ...
  */
  ...
  serialize(writer: __BinaryWriter, value: ElementDataChange): void {
    __AlgebraicTypeValue.serializeValue(writer, ElementDataChange.getTypeScriptAlgebraicType(), value);
  },

  deserialize(reader: __BinaryReader): ElementDataChange {
    return __AlgebraicTypeValue.deserializeValue(reader, ElementDataChange.getTypeScriptAlgebraicType());
  },
