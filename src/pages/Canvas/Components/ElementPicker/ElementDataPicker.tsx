...
export const ElementDataPicker = () => {
  ...
  return (
    <div className="absolute justify-self-center bottom-20 w-[485px] h-[500px] bg-[#1e212b] rounded-[8px] overflow-hidden flex flex-col appear">
      <div className="flex pt-4 pl-4 gap-2">
        <CategoryButton selected={selectedCategory === Category.Images} onClick={() => changeCategory(Category.Images)}>
          images
        </CategoryButton>
        <CategoryButton selected={selectedCategory === Category.Emotes} onClick={() => changeCategory(Category.Emotes)}>
          emotes
        </CategoryButton>
        <CategoryButton
      ...
      <div className="h-full w-full mt-2 border-t-1 border-[#14151b] overflow-y-scroll">
