...
let _cached_UpdateElementFolder_type_value: __AlgebraicTypeType | null = null;
...
export const UpdateElementFolder = {
  ...
  */
  getTypeScriptAlgebraicType(): __AlgebraicTypeType {
    if (_cached_UpdateElementFolder_type_value) return _cached_UpdateElementFolder_type_value;
    _cached_UpdateElementFolder_type_value = __AlgebraicTypeValue.Product({ elements: [] });
    _cached_UpdateElementFolder_type_value.value.elements.push(
    ...
    return _cached_UpdateElementFolder_type_value;
  },
