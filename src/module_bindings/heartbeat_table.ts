 ...
 */
export class HeartbeatTableHandle<TableName extends string> implements __TableHandle<TableName> {
  // phantom type to track the table name
  readonly tableName!: TableName;
  tableCache: __TableCache<Heartbeat>;

  constructor(tableCache: __TableCache<Heartbeat>) {
