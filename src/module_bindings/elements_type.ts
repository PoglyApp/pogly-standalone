...
export const Elements = {
  ...
  */
  ...
  serialize(writer: __BinaryWriter, value: Elements): void {
    __AlgebraicTypeValue.serializeValue(writer, Elements.getTypeScriptAlgebraicType(), value);
  },

  deserialize(reader: __BinaryReader): Elements {
    return __AlgebraicTypeValue.deserializeValue(reader, Elements.getTypeScriptAlgebraicType());
  },
