...
let _cached_UpdateElementDataFolder_type_value: __AlgebraicTypeType | null = null;
...
export const UpdateElementDataFolder = {
  ...
  */
  getTypeScriptAlgebraicType(): __AlgebraicTypeType {
    if (_cached_UpdateElementDataFolder_type_value) return _cached_UpdateElementDataFolder_type_value;
    _cached_UpdateElementDataFolder_type_value = __AlgebraicTypeValue.Product({ elements: [] });
    _cached_UpdateElementDataFolder_type_value.value.elements.push(
      { name: "dataId", algebraicType: __AlgebraicTypeValue.U32 },
      { name: "folderId", algebraicType: __AlgebraicTypeValue.U32 },
    );
    return _cached_UpdateElementDataFolder_type_value;
  },
