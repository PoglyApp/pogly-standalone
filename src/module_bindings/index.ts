...
const REMOTE_MODULE = {
  tables: {
    ...
    Permissions: {
      ...
      primaryKeyInfo: {
        colName: "identity",
        colType: (Permissions.getTypeScriptAlgebraicType() as __AlgebraicTypeVariants.Product).value.elements[0].algebraicType,
      },
    },
    ZIndex: {
      tableName: "ZIndex",
...
export class RemoteReducers {
  ...
  setIdentityPermission(identity: __Identity, permissionLevel: PermissionLevel) {
    const __args = { identity, permissionLevel };
    let __writer = new __BinaryWriter(1024);
  ...
  onSetIdentityPermission(callback: (ctx: ReducerEventContext, identity: __Identity, permissionLevel: PermissionLevel) => void) {
    this.connection.onReducer("SetIdentityPermission", callback);
  }

  removeOnSetIdentityPermission(callback: (ctx: ReducerEventContext, identity: __Identity, permissionLevel: PermissionLevel) => void) {
