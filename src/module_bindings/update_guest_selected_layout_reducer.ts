 ...
 */
export const UpdateGuestSelectedLayout = {
  /**
  ...
  */
  ...
  serialize(writer: __BinaryWriter, value: UpdateGuestSelectedLayout): void {
    __AlgebraicTypeValue.serializeValue(writer, UpdateGuestSelectedLayout.getTypeScriptAlgebraicType(), value);
  },

  deserialize(reader: __BinaryReader): UpdateGuestSelectedLayout {
    return __AlgebraicTypeValue.deserializeValue(reader, UpdateGuestSelectedLayout.getTypeScriptAlgebraicType());
  },

}

export default UpdateGuestSelectedLayout;
