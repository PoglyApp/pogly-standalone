...
export { DeleteWhitelistUserPlatform };
...
import { SyncAutoInc } from "./sync_auto_inc_reducer.ts";
export { SyncAutoInc };
...
import { WhitelistUser } from "./whitelist_user_reducer.ts";
...
import { AutoIncTableHandle } from "./auto_inc_table.ts";
export { AutoIncTableHandle };
...
import { GuestNamesTableHandle } from "./guest_names_table.ts";
export { GuestNamesTableHandle };
...
import { AutoInc } from "./auto_inc_type.ts";
export { AutoInc };
...
export { GuestChange };
import { GuestNames } from "./guest_names_type.ts";
export { GuestNames };
...
export { StreamingPlatform };
import { TextElement } from "./text_element_type.ts";
export { TextElement };
import { Whitelist } from "./whitelist_type.ts";
export { Whitelist };
...
const REMOTE_MODULE = {
  tables: {
    ...
    AutoInc: {
      tableName: "AutoInc" as const,
      rowType: AutoInc.getTypeScriptAlgebraicType(),
      primaryKey: "version",
      primaryKeyInfo: {
        colName: "version",
        colType: (AutoInc.getTypeScriptAlgebraicType() as __AlgebraicTypeVariants.Product).value.elements[0].algebraicType,
      },
    },
    Config: {
    ...
    GuestNames: {
      tableName: "GuestNames" as const,
      rowType: GuestNames.getTypeScriptAlgebraicType(),
      primaryKey: "identity",
      primaryKeyInfo: {
        colName: "identity",
        colType: (GuestNames.getTypeScriptAlgebraicType() as __AlgebraicTypeVariants.Product).value.elements[0].algebraicType,
      },
    },
    Guests: {
    ...
    Whitelist: {
      tableName: "Whitelist" as const,
      rowType: Whitelist.getTypeScriptAlgebraicType(),
    },
    ZIndex: {
  ...
  reducers: {
    ...
    DeleteWhitelistUser: {
      ...
      argsType: DeleteWhitelistUser.getTypeScriptAlgebraicType(),
    },
    DeleteWhitelistUserPlatform: {
      reducerName: "DeleteWhitelistUserPlatform",
      argsType: DeleteWhitelistUserPlatform.getTypeScriptAlgebraicType(),
    },
    DuplicateLayout: {
    ...
    SyncAutoInc: {
      reducerName: "SyncAutoInc",
      argsType: SyncAutoInc.getTypeScriptAlgebraicType(),
    },
    ...
    WhitelistUser: {
      reducerName: "WhitelistUser",
      argsType: WhitelistUser.getTypeScriptAlgebraicType(),
    },
  },
  versionInfo: {
    cliVersion: "1.7.0",
...
| { name: "SyncAutoInc", args: SyncAutoInc }
...
| { name: "WhitelistUser", args: WhitelistUser }
;
...
export class RemoteReducers {
  ...
  deleteWhitelistUser(username: string) {
    ...
    let __writer = new __BinaryWriter(1024);
    DeleteWhitelistUser.serialize(__writer, __args);
    let __argsBuffer = __writer.getBuffer();
    this.connection.callReducer("DeleteWhitelistUser", __argsBuffer, this.setCallReducerFlags.deleteWhitelistUserFlags);
  }

  onDeleteWhitelistUser(callback: (ctx: ReducerEventContext, username: string) => void) {
    this.connection.onReducer("DeleteWhitelistUser", callback);
  }

  removeOnDeleteWhitelistUser(callback: (ctx: ReducerEventContext, username: string) => void) {
    this.connection.offReducer("DeleteWhitelistUser", callback);
  }

  deleteWhitelistUserPlatform(platform: StreamingPlatform, username: string) {
    const __args = { platform, username };
    let __writer = new __BinaryWriter(1024);
    DeleteWhitelistUserPlatform.serialize(__writer, __args);
    let __argsBuffer = __writer.getBuffer();
    this.connection.callReducer("DeleteWhitelistUserPlatform", __argsBuffer, this.setCallReducerFlags.deleteWhitelistUserPlatformFlags);
  }

  onDeleteWhitelistUserPlatform(callback: (ctx: ReducerEventContext, platform: StreamingPlatform, username: string) => void) {
    this.connection.onReducer("DeleteWhitelistUserPlatform", callback);
  }

  removeOnDeleteWhitelistUserPlatform(callback: (ctx: ReducerEventContext, platform: StreamingPlatform, username: string) => void) {
    this.connection.offReducer("DeleteWhitelistUserPlatform", callback);
  }
  ...
  syncAutoInc() {
    this.connection.callReducer("SyncAutoInc", new Uint8Array(0), this.setCallReducerFlags.syncAutoIncFlags);
  }

  onSyncAutoInc(callback: (ctx: ReducerEventContext) => void) {
    this.connection.onReducer("SyncAutoInc", callback);
  }

  removeOnSyncAutoInc(callback: (ctx: ReducerEventContext) => void) {
    this.connection.offReducer("SyncAutoInc", callback);
  }
...
export class SetReducerFlags {
  ...
  deleteWhitelistUser(flags: __CallReducerFlags) {
    this.deleteWhitelistUserFlags = flags;
  }

  deleteWhitelistUserPlatformFlags: __CallReducerFlags = 'FullUpdate';
  deleteWhitelistUserPlatform(flags: __CallReducerFlags) {
    this.deleteWhitelistUserPlatformFlags = flags;
  }
  ...
  syncAutoIncFlags: __CallReducerFlags = 'FullUpdate';
  syncAutoInc(flags: __CallReducerFlags) {
    this.syncAutoIncFlags = flags;
  }
  ...
  whitelistUserFlags: __CallReducerFlags = 'FullUpdate';
  whitelistUser(flags: __CallReducerFlags) {
    this.whitelistUserFlags = flags;
  }
...
export class RemoteTables {
  ...
  get autoInc(): AutoIncTableHandle<'AutoInc'> {
    // clientCache is a private property
    return new AutoIncTableHandle((this.connection as unknown as { clientCache: __ClientCache }).clientCache.getOrCreateTable<AutoInc>(REMOTE_MODULE.tables.AutoInc));
  }
  ...
  get guestNames(): GuestNamesTableHandle<'GuestNames'> {
    // clientCache is a private property
    return new GuestNamesTableHandle((this.connection as unknown as { clientCache: __ClientCache }).clientCache.getOrCreateTable<GuestNames>(REMOTE_MODULE.tables.GuestNames));
  }
  ...
  get whitelist(): WhitelistTableHandle<'Whitelist'> {
    // clientCache is a private property
    return new WhitelistTableHandle((this.connection as unknown as { clientCache: __ClientCache }).clientCache.getOrCreateTable<Whitelist>(REMOTE_MODULE.tables.Whitelist));
  }
